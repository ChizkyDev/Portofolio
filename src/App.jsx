    ...
    <>
      <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
        <div className="animate__animated animate__fadeInUp animate__delay-1s">
          <div className="flex items-center gap-3 mb-6 bg-zinc-800 w-fit p-4 rounded-2xl">
            <img src={Andra} alt="Andra Logo" className="w-10 rounded-md" loading="lazy"/>
            <q>Tetap semangat untuk meraih kesuksesan</q>
          </div>
          ...
          <div className="flex items-center sm:gap-4 gap-2">
            ...
            >
              CV <i className="ri-download-line ri-lg"></i>
            </a>
            <a
              href="#proyek"
        ...
        <img src={Andra} alt="Andra Logo" className="w-115 h-120 md:ml-auto animate__animated animate__fadeInUp animate__delay-1s" loading="lazy" />
      </div>
      ...
      <div className="tentang mt-32 py-10 " id="tentang">
        ...
        data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
         <img src={Andra} alt="Andra Logo" className="w-12 rounded-md mb-10 sm:hidden" loading="lazy"/>
          <p className="text-base/loose mb-10">
            Halo, saya wahyu andra ardiyansyah Seorang yang suka belajar hal baru,
            terutama di bidang teknologi dan kreatif.Saya percaya bahwa setiap
            project adalah langkah untuk berkembang, bukan hanya soal hasil,
            tapi juga proses di baliknya. Portofolio ini mencerminan perjalanan saya dalam belajar
            dan berkarya.
          </p>
          <div className="flex items-center justify-between">
            <img src={Andra} alt="Andra Logo" className="w-12 rounded-md sm:block hidden" loading="lazy" />
        ...
        <div className="tools mt-32">
          ...
          <p className="xl:w-2/5 lg:w-2/4 md:w-2/3 sm:w-3/4 w-full text-base/loose opacity-50" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300" data-aos-once="true">Berikut ini beberapa tools yang dipakai untuk pembuatan Website ataupu desaign </p>
      ...
      <div className="proyek mt-32 py-10" id="proyek">
        ...
        <p className="text-base/loose text-center opacity-50" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300" data-aos-once="true">Berikut ini proyek yang saya buat</p>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {proyek.tools.map((tool,index) =>(
                    <p className="py-1 px-2 border border-zinc-500 bg-zinc-600 rounded-md font-semibold" key={index}>{tool}</p>
                  ))}
                </div>
      ...
      <div className="kontak mt-32 sm:p-10 p-0" id="kontak">
        ...
        <form action="https://formsubmit.co/andrawahyu891@email.com" method="POST"className="bg-zinc-800 p-10 sm:w-fit w-full mx-auto rounded-md " autoComplete="off" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500" data-aos-once="true">
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2">
              <label className="font-simibold">Email</label>
